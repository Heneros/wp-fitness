...
?>
    <main class="main-content">
      <h1 class="sr-only"> Домашняя страница спортклуба Sportfaza. </h1>
      <div class="banner">
      ...
      <article class="about">
        <div class="wrapper about__flex">
          <div class="about__wrap">
            ...
            <p class="about__text"> Спортивный клуб Sportfaza существует уже более 5 лет. За это время большое количество посетителей получили положительный результат от своих тренировок. Мы предлагаем посещать просторный и укомплектованный тренажерный зал с персональными тренерами, массаж, групповые занятия (фитнес), занятия единоборствами в группах и индивидуально, и большое количество тренировок для детей. В каждый абонемент входит посещение финской сауны </p>
